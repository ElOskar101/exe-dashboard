...
interface BotStepProps {
  ...
  isSearchingCustomers: ReturnType<
    typeof useExecutionWizard
  >['isSearchingCustomers']
  customerSearchError: ReturnType<
    typeof useExecutionWizard
  >['customerSearchError']
  selectedCustomerError: ReturnType<
    typeof useExecutionWizard
  ...
  hasSelectedCustomerWithoutClinics: ReturnType<
    typeof useExecutionWizard
  >['hasSelectedCustomerWithoutClinics']
  onCustomerSearchChange: ReturnType<
    typeof useExecutionWizard
  >['updateCustomerSearch']
  onCustomerClear: ReturnType<
    typeof useExecutionWizard
        ...
        <Field data-invalid={showErrors && Boolean(contextErrors.clinic)}>
          ...
          >
            <SelectTrigger
              ...
              className="w-full"
            >
              <SelectValue placeholder={t('placeholders.clinic')}>
                {context.clinicName || undefined}
              </SelectValue>
            </SelectTrigger>
